...
const Bg = () => {
  return (
    <div className="relative  h-[100%] ">
      <div className="absolute bottom-14 md:bottom-10 right-6 sm:right-3 rotate-12  ">
      ...
      <div className="absolute  bottom-12 sm:bottom-14 -rotate-45 -left-4 sm:-left-9 ">
        <img src={ball} alt="img" className="h-16 sm:h-28 md:h-32 " />
      </div>
      ...
      <div className="absolute  bottom-0 sm:bottom-40 right-0">
        <img src={trophy} alt="img" className="h-14 sm:h-20 md:h-24 " />
      </div>

      

      <div className="absolute bottom-0 sm:left-16 lg:left-11">
        <img src={cricketer} alt="img" className="h-6 sm:h-10 md:h-14 " />
      </div>


      <div className="absolute bottom-32 md:left-16  ">
        <img src={ball1} alt="img" className="h-16 sm:h-28 md:h-32 " />
      </div>
      ...
      <div className="absolute left-0 sm:left-6 bottom-32 sm:bottom-40 -rotate-12 ">
        <img src={trophy1} alt="img" className="h-8 sm:h-20 md:h-24 " />
      </div>
